...
private:
	...
	//static constexpr double kSpiLeadingZerosNs = 50000; // determined empirically original
	//static constexpr double kSpiLeadingZerosNs = 220000; // determined empirically for SKC6812RV
	static constexpr double kSpiLeadingZerosNs = 0; // when signal is inverted
